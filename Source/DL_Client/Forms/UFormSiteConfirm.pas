...
begin
  ...
  begin
    ...
    if Pos('砖',EditStockName.Text)>0 then
    begin
      InitKuWei('砖块',cbxKw,FLocationIDList);
    end
    else if pos('熟',EditStockName.Text)>0 then
    begin
      InitKuWei('熟料',cbxKw,FLocationIDList);
    end else
    if pos('袋',EditStockName.Text)>0 then
    begin
      InitKuWei('袋装',cbxKw,FLocationIDList);
    end else
    begin
      InitKuWei('散装',cbxKw,FLocationIDList);
    end;
