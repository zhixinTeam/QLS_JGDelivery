...
type
  ...
  TBrickItem = record
    Fcode:string;                    //代码
    FSquareOfPerTon:Double;          //每吨XX平
    FTonOfPerSquare:double;          //每平XX吨
  end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        Fszbz     := Values['szbz'];              //散装标重
        Fcolor    := Values['color'];             //颜色
	      FYSTDno   := Values['YSTDNO'];            //验收通道
      end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        Values['szbz']       := Fszbz;              //散装标重
        Values['color']      := Fcolor;             //颜色
	      Values['YSTDNO']     := FYSTDNO;            //验收通道
      end;
